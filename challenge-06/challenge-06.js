...
desafio.
*/
let teams = ['São Paulo', 'Corinthians', 'Bragantino', 'Ferroviária', 'Palmeiras']
...
function showTeamPosition(num){
  ...
  return num <= 5? `O time que está em ${num--}º lugar é o ${teams[num--]}.` : `A posição informada foi ${num}. Não temos a informação do time que está nessa posição.`
}
